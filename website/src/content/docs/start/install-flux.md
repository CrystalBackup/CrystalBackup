...
spec:
  ...
  ref:
    tag: "0.5.1"        # the pin. Bumping this IS the upgrade.
```
...
```bash
cosign verify ghcr.io/crystalbackup/charts/crystal-backup:0.5.1 \
...
```bash
helm pull oci://ghcr.io/crystalbackup/charts/crystal-backup --version 0.5.1 --untar
