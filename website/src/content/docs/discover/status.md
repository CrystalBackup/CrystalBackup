...
The current release is **`v0.6.4`**. Milestones M0 through M6 have shipped: the core
...
rollout. That is why **0.6.4 is offered for testing in real conditions, not for
