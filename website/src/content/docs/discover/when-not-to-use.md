...
`v0.6.5` ran unfiltered:
[93 of 93 checks](/CrystalBackup/reports/crucible-m6-5.html), nothing failed and nothing
skipped — on the **second** attempt, the first having stopped at its four-hour timeout with
21 of those 93 checks never reached. But the CRD
