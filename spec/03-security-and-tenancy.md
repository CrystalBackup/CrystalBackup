...
- **KEK escrow**: the cluster KEK is generated and escrowed in the platform secret store
  *outside* the cluster before first use — losing the cluster must not lose the KEK
  (platform DR, R22).
